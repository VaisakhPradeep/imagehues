...
function extractPaletteFromPixels(data, width, height, quality, count) {
    const bins = new Map();
    const binSize = 20;
    let sampledPixels = 0;
...
function extractPaletteFromImage(img, quality, count) {
    ...
    return extractPaletteFromPixels(imageData.data, width, height, quality, count);
}

const paletteExtract = {
    extractPaletteFromPixels,
    extractPaletteFromImage,
};

window.PaletteExtract = paletteExtract;
